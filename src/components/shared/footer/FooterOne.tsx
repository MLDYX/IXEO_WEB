            ...
            <RevealAnimation delay={0.3}>
              <div className="max-w-[306px]">
                ...
                <p className="text-accent/60 text-tagline-1 mt-4 mb-7 font-normal">
                  We craft software that streamlines ops and saves teams time.
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div className="bg-stroke-1/20 h-6 w-px"></div>
                  <Link target="_blank" href="https://www.x.com" className="footer-social-link">
                    <span className="sr-only">X</span>
                    <Image className="size-4 invert" src={xLogo} alt="X" />
                  </Link>
                </div>
              </div>
            </RevealAnimation>
